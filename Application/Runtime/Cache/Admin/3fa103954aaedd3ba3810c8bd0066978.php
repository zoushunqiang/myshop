  ...
  <div class="box">
    <div class="box_border">
      ...
      <div class="box_center">
        <form action="<?php echo U('User/doChange');?>" class="jqtransform" method="post">
         <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td class=""> 
              <input type="text" name="password" class="input-text lh30" size="40" placeholder="不填写表示不修改" >
            </td>
          </tr>
          <tr>
            <td class="td_right">手机号：</td>
            <td class=""> 
              <input type="text" name="tel" class="input-text lh30" size="40" value="<?php echo ($Info["tel"]); ?>">
            </td>
          </tr>
          <tr>
            <td class="td_right">性别：</td>
            <td class="">
              <?php if($Info["sex"] == '男' ): ?><input type="radio" name="sex" checked  value="男"> 男
              ...
              <?php else: ?>
                <input type="radio" name="sex" value="男"> 男
                <input type="radio" name="sex" value="女"> 女<?php endif; ?>
            </td>
          </tr>
