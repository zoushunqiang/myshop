    ...
    <div class="box">
      <div class="box_border">
        ...
        <div class="box_center">
          <form action="<?php echo U('Content/doAdd');?>" class="jqtransform" method="post">
            <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="td_right">标题：</td>
                <td class=""> 
                  <input type="text" name="title" class="input-text lh30" size="40" value="">
                </td>
              </tr>
              <tr>
                <td class="td_right">文本框：</td>
                <td class="">
                <textarea name="content" id="content" cols="30" rows="10" style="width:90%;height:300px" ></textarea>
                </td>
              </tr>
