	...
	<div class="shop_goods_show">
		<div class="shop_goods_show_left">
			...
			<div class="shop_goods_show_right" style="margin-top: 50px;">
				<ul> 
					<form action="<?php echo U('Cart/cart',array('pid'=>$Info['pid']),'');?>" method="post">
						<li>
						...
						<li class="goods_num">
							...
							<span>
								...
								<input type="text" value="1" name="good_nums" id="good_nums" class="good_nums" />
								<a href="javascript:void(0);" id="good_num_jia" class="good_num_jia"></a>(当前库存<b><?php echo ($Info["stock"]); ?></b>件)
							</span>
						</li>
				...
				<div class="contents clearfix">
					<ul class="clearfix">
						<?php if(is_array($is_hot)): $i = 0; $__LIST__ = $is_hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix">					
								<div class="goods_pic"><a href="<?php echo U('Product/info',array('pid'=>$vo['pid']),'');?>"><img src="<?php echo ($vo["water_img"]); ?>" width="160" height=160 /></a></div>
								<div class="goods_name"><a href="<?php echo U('Product/info',array('pid'=>$vo['pid']),'');?>"><?php echo (Mystrsub($vo["title"])); ?></a></div>
								<div class="goods_xiaoliang">
									<span class="goods_xiaoliang_link"><a href="<?php echo U('Product/info',array('pid'=>$vo['pid']),'');?>">去看看</a></span>
