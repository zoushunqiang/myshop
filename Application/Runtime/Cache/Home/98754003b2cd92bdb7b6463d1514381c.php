  ...
  <div class="shop_hd">
    ...
    <div class="shop_hd_menu">
      ...
      <ul class="shop_hd_menu_nav" style="margin-left: -150px;">
        ...
        <li class="link"><a href="<?php echo U('Index/Product');?>"><span>产品列表</span></a></li>
		...
		<div class="shop_goods_show_left">
			...
			<div id="preview">
				<div class=jqzoom >
					...
					<IMG height="350" src="/Public/Home/images/img04.jpg" jqimg="/Public/Home/images/img04.jpg" width="350">
					</div>
			...
			<div class="shop_bd_list_bk clearfix">
				...
				<div class="contents clearfix">
					<ul class="clearfix">
						...
						<li class="clearfix">					
							<div class="goods_pic"><a href=""><img src="/Public/Home/images/89a6d6466b00ae32d3c826b9ec639084.jpg_small.jpg" /></a></div>
							<div class="goods_name"><a href="">Gap经典弹力纯色长袖T恤|000891347|原价149元</a></div>
							<div class="goods_xiaoliang">
								<span class="goods_xiaoliang_link"><a href="">去看看</a></span>
								<span class=" goods_xiaoliang_nums goods_price">¥ 279.00 </span>
							</div>
						</li>
			...
			<div class="shop_goods_bd_xiangqing_tab">
				...
				<div class="shop_goods_bd_xiangqing_content clearfix">
					<div class="xiangqing_contents clearfix">
						<p><img src="/Public/Home/images/pic3.jpg" width="640" height="844"></p>
					</div>
				</div>
			</div>
			<!-- 商品详情 End -->
